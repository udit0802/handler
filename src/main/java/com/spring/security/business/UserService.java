...
//  
//  public String saveOTP(String mobileNo,String otp,
//          String requestToken,long otpGeneartionTime) throws ApplicationException;
//  
...
//  
//  public void saveTokenStoreManager(String olmId,
//          String token,User user) throws ApplicationException;
//  
//  public void deletePreviousTokenStoreManager(String olmId) throws ApplicationException;
//  
//  public Token getTokenUserDetailsStoreManager(String token,
//          String userIdentifier) throws ApplicationException;
//  
  public Merchandiser getMerchandiserDetail(String phoneNo) throws ApplicationException;
//  
  public String saveOTPMerchandiser(String mobileNo,String otp,
          String requestToken,long otpGeneartionTime) throws ApplicationException;
//  
